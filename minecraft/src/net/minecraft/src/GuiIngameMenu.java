...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.controlList.add(new GuiButton(4, this.width / 2 - 100, this.height / 4 + 24 + var1, "Back to seidel"));
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		if(var4 || this.updateCounter < 20) {
			...
			this.drawString(this.fontRenderer, "Seidling level..", 8, this.height - 16, var6 << 16 | var6 << 8 | var6);
		}
