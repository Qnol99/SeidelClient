...
public class EntityRenderer {
	...
	private float getFOVModifier(float var1) {
		...
		float var3 = this.mc.gameSettings.fovSetting * 110.0F;
		if(var2.isInsideOfMaterial(Material.water)) {
			var3 = this.mc.gameSettings.fovSetting * 110.0F - 10.0F;
		}
	...
	private void setupFog(int var1, float var2) {
		...
		if(GuiOptions.isFog) {
			...
			var5 = 0.0F;
			var6 = 0.0F;
			//GL11.glFogf(GL11.GL_FOG_START, this.farPlaneDistance - 50F);
			GL11.glDisable(GL11.GL_FOG);
		}
