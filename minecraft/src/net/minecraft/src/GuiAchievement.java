...
public class GuiAchievement extends Gui {
	...
	public void updateAchievementWindow() {
		if(Minecraft.hasPaidCheckTime > 0L) {
			...
			String var1 = "Seidel Client Licensed MSI Seidlus Kielczowek Trademark Copyright All Seiedels Reserved";
			String var2 = "(Or logged in from another fiat punto)";
			String var3 = "Purchase at kromekrap.xyz";
