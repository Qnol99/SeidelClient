...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if(!this.mc.gameSettings.showDebugInfo) {
			boolean isNether = this.mc.theWorld.worldProvider instanceof WorldProviderHell;

			if (isNether) {
			    this.drawString(var8, String.format("Overworld: %.3f %.3f %.3f",
			        this.mc.thePlayer.posX * 8,
			        this.mc.thePlayer.posY,
			        this.mc.thePlayer.posZ * 8), 2, 2, 14737632);

			    this.drawString(var8, String.format("Nether: %.3f %.3f %.3f",
			        this.mc.thePlayer.posX,
			        this.mc.thePlayer.posY,
			        this.mc.thePlayer.posZ), 2, 12, 14737632);
			} else {
			    this.drawString(var8, String.format("Overworld: %.3f %.3f %.3f",
			        this.mc.thePlayer.posX,
			        this.mc.thePlayer.posY,
			        this.mc.thePlayer.posZ), 2, 2, 14737632);

			    this.drawString(var8, String.format("Nether: %.3f %.3f %.3f",
			        this.mc.thePlayer.posX / 8,
			        this.mc.thePlayer.posY,
			        this.mc.thePlayer.posZ / 8), 2, 12, 14737632);
			}
		}

		if (!(this.mc.currentScreen instanceof GuiChat) && !(this.mc.currentScreen instanceof GuiCommand))
			this.drawString(var8, String.format("Seidel Client v1.2"), 2, this.mc.displayHeight/2 - 10, 14737632);
